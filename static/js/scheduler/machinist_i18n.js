...
const TRIAL_MACHINIST_STRINGS = {
  en: {
    ...
    mpp_lanes_on_title: 'Hide CNC 35, 36, and 41 plan lanes',
    mpp_lanes_show_title: 'Show CNC 35, 36, and 41 plan lanes',
  ...
  zh: {
    ...
    mpp_lanes_on_title: '隐藏 CNC 35、36、41 计划列',
    mpp_lanes_show_title: '显示 CNC 35、36、41 计划列',
